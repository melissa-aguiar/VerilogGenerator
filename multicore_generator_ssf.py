def main():
    ...
    #  ########################################## PARAMETROS ###########################################################
    procs = 48  # numero de processadores pra gerar o multicore.v e multicore_tb.v
    freq = 1042  # frequencia do clock no _tb
    mlt = 8  # numero de multiplicadores pra colocar entre as entradas do .asm
    nubits = 32  # numero de bits dos processadores
    extra = 641  # numero a mais de MLT pra colocar na saida pra atrasar ela e sincronizar as janelas de entrada
    ...
    f2.write("LOAD 0" + '\n')
    for j in range(mlt+1+extra):
        f2.write("MLT -1" + '\n')
    f2.write("PLD 0" + '\n' + "OUT" + '\n')

    f2.write("LOAD 0" + '\n')
    for j in range(mlt+1):
        f2.write("MLT -1" + '\n')
    f2.write("PLD 0" + '\n' + "OUT" + '\n')
    ...
    f12 = open("C:/Users/melis/Desktop/GitDesk/ssf/ssf/Hardware/ssf_H/multicore.v", "w+")
    ...
    for i in range(procs):
        f12.write("ssf ssf" + str(i) + " (clk, rst" + str(i) + ", io_in, io_out" + str(i) + ", req_in" +
                  str(i) + ", out_en" + str(i) + ");" + '\n')
    f12.write("endmodule" + '\n')
    f12.write('\n')
    f12.close()
    ...
    #  ################################################ TESTBENCH MULTICORE ############################################
    f13 = open("C:/Users/melis/Desktop/GitDesk/ssf/ssf/Hardware/ssf_H/multicore_tb.v", "w+")
